...
var something5 = require('../page-five/page-five');
      ...
      `;
      // act
      const resultMap = utils.findNodeModuleImports(knownContent);
  ...
  describe('getModulesImportedByImportee', () => {
    it('should return a set of modules imported by a givevn module', () => {
      ...
      // act
      const results = utils.getModulesImportedByImportee(map, ionicAngular);
...
export class HomePage {
  ...
  nextPage() {
    ...
    console.log()
      ...
      const result = utils.processImports(dependencyMap, pageOne, knownContent, nodeModulesDir);
